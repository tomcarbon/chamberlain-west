...
Vue.component('tec-cv', {
        template: `
                        ...
                        <h3>Chronology</h3>
                                ...
                                <p class="specialp">2016 February: Developed Milgrom's empirical Vf=(GMa0)1/4 as  theoretical VL=21/2(GMcH0)1/4 within up-to-date relativity physics. (Corrected Vf=(GMcH0)1/4 toVL=21/2(GMcH0)1/4 in the prior revision.)</p>
...
const cwmainapp = new Vue({
	...
	template: `
		<div >
			<div id="theprimary" class="col-xs-12 col-sm-3 col-md-2">
			...
			<div class="col-xs-12 col-sm-9 col-md-10" color="black">
				<tec-cv />
	                        <economicsapp />
	                        <physicsapp />
			</div>
